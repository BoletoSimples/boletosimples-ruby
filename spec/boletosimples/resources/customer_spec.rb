  ...
  describe 'methods' do
    ...
    describe 'create' do
      context 'valid parameters' do
        ...
        it { expect(subject.attributes.keys).to match_array(%w[person_name cnpj_cpf email address city_name state neighborhood zipcode address_number address_complement phone_number mobile_number person_type mobile_local_code created_via_api id]) }
      end
