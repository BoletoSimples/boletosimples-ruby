  ...
  describe 'methods' do
    ...
    describe 'create' do
      context 'valid parameters' do
        ...
        it { expect(subject.attributes.keys).to match_array(%w[amount description expire_at customer_address customer_address_complement customer_address_number customer_city_name customer_cnpj_cpf customer_email customer_neighborhood customer_person_name customer_person_type customer_phone_number customer_state customer_zipcode notification_url id paid_at status shorten_url send_email_on_creation created_via_api paid_amount]) }
      end
